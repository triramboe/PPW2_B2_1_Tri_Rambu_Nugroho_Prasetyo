...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2023 at 09:24 AM
...
(18, '2023_09_26_063302_create_suplier', 1),
(19, '2023_09_26_063308_create_gudang_barang', 1);
...
ALTER TABLE `gudang_barang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `gudang_barang_id_suplier_foreign` (`id_suplier`);
...
--
ALTER TABLE `gudang_barang`
  ADD CONSTRAINT `gudang_barang_id_suplier_foreign` FOREIGN KEY (`id_suplier`) REFERENCES `suplier` (`id`);
COMMIT;
